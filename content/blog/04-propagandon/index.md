...
lastmod: 2024-08-11T13:27:03.447Z
...
И вот, **это случилось**, третий день трубе плохо и не грузятся видео.

![Russia youtube users be like...](https://i.imgur.com/C6CX2kL.gif)
{{<alert "admo/question" >}}
`Что случилось с Youtube?`
_[Это гос-во](https://neolurk.org/wiki/%D0%AD%D1%82%D0%B0_%D1%81%D1%82%D1%80%D0%B0%D0%BD%D0%B0)_ уверенно двигается к [чебурнету](https://neolurk.org/wiki/%D0%A7%D0%B5%D0%B1%D1%83%D1%80%D0%BD%D0%B5%D1%82), т.к теперь весь траффик пропускается через [DeepPacketInspector](https://ru.wikipedia.org/wiki/Deep_packet_inspection), аналогично [Great Firewall (англ. вики)](https://en.wikipedia.org/wiki/Great_Firewall#Active_filtering)
{{</alert>}}
{{<alert "admo/success" >}}
`Обход?`
Можно попробовать пару утилит, но гарантий нет. На некоторых провайдерах может и не взлететь.
...
Быть отрезанным от новостей цивилизованного мира[^usual], раздражает и пугает одновременно.
Важно понимать, это только начало. Статья на вики, явно дает понять, что китайский брат еще многому может научить. Скоро и ВПН не останется в стороне.
Но с другой стороны, это не смогло остановить **вольных** самураев и пока им удается обходить блокировки. Сколь технологичней анальное зондирование не становилось.
Но рядовым обывателям от этого не проще.

[^usual]: В привычном формате как минимум.

## Прогноз

При всем желании, ++сделать++ свой **_"суверенный ~~ютаб~~ былибыли[^bb]"_**, у _этого гос-ва_, закономерно не вышло и google доминирует в этом сегменте рынка. Возможно, этот факт и берег детище гугла все это время от [банхаммеров](https://neolurk.org/wiki/%D0%91%D0%B0%D0%BD%D1%85%D0%B0%D0%BC%D0%BC%D0%B5%D1%80), блокировок и прочего [кибер-буллинга](https://ru.wikipedia.org/wiki/%D0%98%D0%BD%D1%82%D0%B5%D1%80%D0%BD%D0%B5%D1%82-%D1%82%D1%80%D0%B0%D0%B2%D0%BB%D1%8F) со стороны **[Роскомпозора](https://ru.wiktionary.org/wiki/%D0%A0%D0%BE%D1%81%D0%BA%D0%BE%D0%BC%D0%BF%D0%BE%D0%B7%D0%BE%D1%80)**. Не смотря на то что он всегда был поперек горла _этой власти_.
...
Внезапно, **_[суверенный чебурнет](https://ru.wikipedia.org/wiki/%D0%97%D0%B0%D0%BA%D0%BE%D0%BD_%D0%BE_%C2%AB%D1%81%D1%83%D0%B2%D0%B5%D1%80%D0%B5%D0%BD%D0%BD%D0%BE%D0%BC_%D0%B8%D0%BD%D1%82%D0%B5%D1%80%D0%BD%D0%B5%D1%82%D0%B5%C2%BB)_ и _[кибер-гулаг](https://city4people.ru/post/kibergulag-raspravil-plechi.html)_** оказался на пороге. Может преувеличение, однако темпы строительства _анального огорода_ для чебурашки, маловероятно останутся прежними. Риск стал настолько осязаемым и не столь далекими, что вероятность проснуться в совсем _другом гов-не_ теперь вопрос времени и не столь отдаленного.  
...
2) ВК новый контент выпускают 3.5 недалеких пропагандона, выставленных из цивилизованных мест. :kappa:
...
Чего эти [филистеры](https://ru.wikipedia.org/wiki/%D0%A4%D0%B8%D0%BB%D0%B8%D1%81%D1%82%D0%B5%D1%80) хотят добиться, очередным выпадом, по большому счету, в сторону своего же народа, остается загадкой. Но у таких действий определенно будут последствия.

## Последствия

![eyes wide closed](https://i.imgur.com/jKXp8We.png)

Тотальная зачистка информационного поля от независимых спикеров, откроют дверку в _самые токсичные_ времена.
И то ли еще будет, учитывая как это уже отразилось на возрастном поколении[^old] (++субъективно++: начала проглядываться **_педерастическая риторика_**[^gay] разной степени мерзости).
И в своем поколении, у "_[ватных приступов](https://ru.wikipedia.org/wiki/%D0%92%D0%B0%D1%82%D0%BD%D0%B8%D0%BA_(%D0%BF%D1%80%D0%BE%D0%B7%D0%B2%D0%B8%D1%89%D0%B5))_" и симптомов **_той риторики_** наблюдается тренд к учащению. В т.ч. у людей осознанно невзаимодействующих с пропагандой.
...
Что-то мне подсказывает что привычные стратегии _[голову в песок_, _побег в себя, отрицание, абстрагирование](https://ru.wikipedia.org/wiki/%D0%97%D0%B0%D1%89%D0%B8%D1%82%D0%BD%D1%8B%D0%B9_%D0%BC%D0%B5%D1%85%D0%B0%D0%BD%D0%B8%D0%B7%D0%BC)_ и т.п. может привести к неожиданным(и нежелательным) последствиям.
...
Блок youtube оказался полной неожиданностью и потребовал неотложной рефлексии на тему "_А что если?_".
...
Например, в случае youtube, беглый анализ заголовков новостной сводки показал:

- за 2 дня до: В новостях начали форсить требовательного характера статьи ("Кто-то что-то потребовал сделать на/от Youtube"),
- за 1: В ход пошли неявные, но очевидные угрозы и обидки ("Махание банхаммером вперемешку с указанием очередного не работающего [манязакона](https://neolurk.org/wiki/%D0%9C%D0%B0%D0%BD%D1%8F%D0%BC%D0%B8%D1%80%D0%BE%D0%BA).")
- И только на след. день реализация угроз.

ИЧСХ, в присущей **педерастической манере**, не беря ответственности. Хуже террориста.
> Мы вас просили и угрожали... но мы не блокировали. Там просто оборудование давно не меняли в нашем сегменте.  

Решил посматривать за происходящим по ту сторону рассудка в общем.
Стоит отметить, царящую аморальность в фабуле любого [пропагандона](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D0%BF%D0%B0%D0%B3%D0%B0%D0%BD%D0%B4%D0%BE%D0%BD).
Даже с холодной головой и полным сознанием что в объективности, [пропагандонские](https://neolurk.org/wiki/%D0%9F%D1%80%D0%BE%D0%BF%D0%B0%D0%B3%D0%B0%D0%BD%D0%B4%D0%BE%D0%BD%D1%8B) высеры имеют гораздо больше общего с _яойными фанфиками[^yaoi]_, чем с журналистикой.
Некоторые вещи сложно читать/лицезреть все же, просто мерзостно.

На фоне этого вспомнил просто старую технологию RSS, которая позволяет собрать различные потоки информации, в одном месте, подробнее в 
{{< button href="/docs/howto-rss" target="_self" >}}RSS:HOW-TO{{< /button >}}
...
По итогу РСС оказался к месту. Теперь _[мета-анализ](https://ru.wikipedia.org/wiki/%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9_%D0%BE%D0%B1%D0%B7%D0%BE%D1%80)_ новостной сводки не занимает много времени. Делается буквально по заголовкам.
...
{{< gallery class="prefrontal" >}}
  {{< img src="https://i.imgur.com/gfQ4BNo.png" title="1/iz.ru" alt="Открывает выставку" >}}
  {{< img src="https://i.imgur.com/kM2x0yz.png" title="2/gazeta.ru" alt="together apes strong" >}}
  {{< img src="https://i.imgur.com/szzNLnl.png" title="3/gazeta.ru" alt="Оксюморон, неплохо! Видать не все журналистское атрофировалось еще! together apes even stronger" >}}
  {{< img src="https://i.imgur.com/Gfl723v.png" title="4/gazeta.ru" alt="смешная инфографика: exchange civils/heroes rates " >}}
  {{< img src="https://i.imgur.com/3pCPFsO.png" title="5/Чуть мацой не подавился" alt="с таких пояснений за безработицу" >}}
  {{< img src="https://i.imgur.com/GD537H6.jpeg" title="6/Meanwhile in kremlin" alt="el Puthos was like.." >}}
  {{< img src="https://i.imgur.com/AL3t4Cv.png" title="7/vz.ru" alt="Взгляд как бы намекающий! в анус" >}}
  {{< img src="https://i.imgur.com/Y5yrEzB.png" title="8/vz.ru" alt="Пасхальные яички Hidden Putler" >}}
  {{< img src="https://i.imgur.com/QtjkGpc.png" title="9/куки *уюки" alt="Что такое RSS, лучше знали" >}}
  {{< img src="https://i.imgur.com/ya8SHWh.png" title="10/RSS not found" alt="Зато можно подписаться! но лучше анус свой подпишите" >}}
  {{< img src="https://i.imgur.com/4pg8CCB.png" title="11/Или фронт писал непутевый студент" alt="Тк в коде страницы нашелся другой"  >}}

{{</gallery>}}

Очень удивило отсутствие RSS на некоторых ресурсах. Хотя казалось бы, технология не сложная и сделана специально в угоду простоты распространения информации. Помимо тех что на скриншотах

_Именитые, но безнадежно отсталые:_
    - <https://www.mk.ru/news/>
    - <https://www.vesti.ru/>
_просто отсталые_, где RSS есть в разметке(коде) т.е. на странице не отображается:
...
Были конечно подозрения что там все очень плохо, но что бы настолько. Небольшая часть сайтов является SPA(Single Page Application), что насколько мне известно, не очень хорошая практика для SEO. Но я не самый опытный фронт разработчик, так что тут Санек меня поправит если что.

{{< gallery class="catcode" >}}
     {{< img src="https://i.imgur.com/Ym0hTTZ.png" title="Оптимизация?" alt="Even me can do better" >}}
     {{< img src="https://i.imgur.com/Tn7cTqo.png" title="Кому вебкит" alt="а натуралу в ебкит" >}}
     {{< img src="https://i.imgur.com/6GWk8Ug.png" title="Дурные практики" alt="Оставлять комменты в продакшене по определению очень скверная практика" >}}
     {{< img src="https://i.imgur.com/H5rgkXz.png" title="А то мало ли кто обнаружит твое русофобское говно" alt="кстати, удивительно что этих нациков еще не слили" >}}
     {{< img src="https://i.imgur.com/Y88gXBl.png" title="запросы в бд" alt="что дальше? пароли админки?" >}}
     {{< img src="https://i.imgur.com/QXHTCdu.png" title="Никакой приватности" alt="Практически все сайты максимально плевали на приватность и крайне агрессивно рассылают данные о каждом клике пользователя в лучшем случае 3 разным сборщикам метрик" >}}
{{< /gallery >}}
...
И тут тоже нашлось с чего посмеяться, написал комменты по некоторым позициям в списке иногентов.
Сразу становится очевидно какие у _этой страны_ **враги** и с чем она борется на деньги **честных налогоплательщиков**.

 {{< img src="https://i.imgur.com/Bu84ev3.jpeg" title="Life sucks" alt="" >}}

***

{{< details type="bug" title="Единый реестр иностранных агентов" >}}
...
{{< details type="danger" title="Единый федеральный список организаций, в том числе иностранных и международных организаций, признанных террористическими" >}}

в том числе иностранных и международных организаций, признанных террористическими
...
[^yaoi]: Яой - жанр японского творчества с центральной тематикой мужских отношений гомосексуального характера. Фанфик - сокращение от фан фикшн, т.е. творчество поклонников/фанатов. По народному поверью яойные фанфики пишут исключительно [яойщицы](https://neolurk.org/wiki/%D0%AF%D0%BE%D0%B9%D1%89%D0%B8%D1%86%D0%B0), страдающие от проблем с лишним весом (именуемые в поверье как `жирухи-яойщицы` или `яойщицы-жирухи`).
