...
_[Это гос-во](https://neolurk.org/wiki/%D0%AD%D1%82%D0%B0_%D1%81%D1%82%D1%80%D0%B0%D0%BD%D0%B0)_ уверенно двигается к [чёбыинету](https://neolurk.org/wiki/%D0%A7%D0%B5%D0%B1%D1%83%D1%80%D0%BD%D0%B5%D1%82), т.к теперь весь траффик пропускается через [DeepPacketInspector](https://ru.wikipedia.org/wiki/Deep_packet_inspection), аналогично [Great Firewall (англ. вики)](https://en.wikipedia.org/wiki/Great_Firewall#Active_filtering)
{{</alert>}}
{{<alert "admo/success" >}}
`Обход?`
...
И советую обратить внимание на описание от разработчика. Особенно на часть где говорится что программа _может_ и **будет** вредить работе других сайтов. И это не дефект, а специфика обхода.
{{</alert>}}

Перспектива лишиться "_youtube_", лично меня, крайне не обрадовала и сильно беспокоит.
...
При всем желании, ++сделать++ свой **_"суверенный ~~youtube~~ былибыли[^bb]"_**, у _этого гос-ва_, закономерно не вышло и  google по прежнему доминирует в этом сегменте рынка. Возможно, этот факт и берег детище гугла все это время от [банхаммеров](https://neolurk.org/wiki/%D0%91%D0%B0%D0%BD%D1%85%D0%B0%D0%BC%D0%BC%D0%B5%D1%80), блокировок и прочего [кибер-буллинга](https://ru.wikipedia.org/wiki/%D0%98%D0%BD%D1%82%D0%B5%D1%80%D0%BD%D0%B5%D1%82-%D1%82%D1%80%D0%B0%D0%B2%D0%BB%D1%8F) со стороны **[Роскомпозора](https://ru.wiktionary.org/wiki/%D0%A0%D0%BE%D1%81%D0%BA%D0%BE%D0%BC%D0%BF%D0%BE%D0%B7%D0%BE%D1%80)**. Не смотря на то что он всегда был поперек горла _этой власти_.
...
Чего эти [филистеры](https://ru.wikipedia.org/wiki/%D0%A4%D0%B8%D0%BB%D0%B8%D1%81%D1%82%D0%B5%D1%80) хотят добиться своим свинским отношением к жителям этой страны, остается загадкой. Но у таких действий определенно будут последствия.
...
Есть сомнения что привычные стратегии _[голову в песок_, _побег в себя, отрицание, абстрагирование](https://ru.wikipedia.org/wiki/%D0%97%D0%B0%D1%89%D0%B8%D1%82%D0%BD%D1%8B%D0%B9_%D0%BC%D0%B5%D1%85%D0%B0%D0%BD%D0%B8%D0%B7%D0%BC)_ и т.п. может привести к неожиданным(и нежелательным) последствиям.
![eyes wide closed](https://i.imgur.com/jKXp8We.png)
_Например_: Проспать вторую волну мобилизации, когда не осталось независимых от гос-ва и публичных спикеров, не то чтобы легко, а ++пиздец как легко++.

{{< alert "admo/quote" >}}
`вспомнился текст песни Asian Dub Foundation - Round Up`
...
Блок youtube стал полной неожиданностью и потребовал неотложной рефлексии на тему "_А что если?_".
...
- за 2 дня до: В сми начали форсить статьи с требованиями ("Кто-то что-то потребовал сделать на/от Youtube"),
- за 1: появились неявные, но очевидные угрозы и обидки ("Махание банхаммером вперемешку с указанием очередного не работающего [манязакона](https://neolurk.org/wiki/%D0%9C%D0%B0%D0%BD%D1%8F%D0%BC%D0%B8%D1%80%D0%BE%D0%BA).")
...
По итогу РСС оказался к месту. Теперь _[мета-анализ](https://ru.wikipedia.org/wiki/%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9_%D0%BE%D0%B1%D0%B7%D0%BE%D1%80)_ пропаганды не занимает много времени. А самое важное, делается буквально по заголовкам.
С таким можно работать.

## Bonus

Пока собирал ленту, пришлось познакомиться с сайтами первой десятки страниц выдачи google, по запросу "_новости России_".
...
Очень удивило отсутствие RSS на некоторых ресурсах. Хотя казалось бы, простая технология повышающая эффективность распространения.  
Помимо тех что на скриншотах
...
И тут тоже нашлось с чего посмеяться, написал комменты по некоторым позициям в списке иноагентов.
