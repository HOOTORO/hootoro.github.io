...
![alt text](https://i.imgur.com/jKXp8We.png)
...
Лонгстори шорт.
Блок трубы оказался неожиданностью, потребовал неотложной рефлексии на тему "_А что если?_".
Которая привела мне к осознанию, простой, но не всегда очевидной мысли - пропаганда тоже информативна, а порой "красноречива", а значит ее можно использовать..
Про нее в 99% верно:
...
Например, с вредительству youtube, беглый анализ заголовков новостной сводки показал:
...
Решил посматривать за происходящим по ту сторону рассудка в общем. Стоит отметить, царящую аморальность в гос-ной гандон-фабуле.
Даже с холодной головой, с полным сознанием что в объективности, пропагандонские высеры имеют гораздо больше общего с _яойными фанфиками[^yaoi]_ чем с журналистикой.
Некоторые вещи все равно сложно читать/лицезреть, просто мерзостно.

На фоне этого вспомнил просто старую технологию RSS, которая позволят сколь угодно инфо-потоков с разнообразных сайтов, собрать в одном месте, для последующей реорганизации, фильтрации и пр. удобностей, про RSS написал отдельный пост, глянуть можно тыкнув кнопку {{< btnlnk "/docs/howto-rss" >}}. Там же можно найти файл пропагандоского фида.
...
Бонусом поделюсь отборными находками из зазеркалья, в двух частях.

### Префронтальная на орбите

1. Открывает выставку <https://iz.ru>
    ![alt text](https://i.imgur.com/gfQ4BNo.png)
2. <https://gazeta.ru/> Неплохой оксюморон! Видать не все журналистское атрофировалось еще!
    ![alt text](resources/image-1.png)
    ![alt text](resources/image-2.png)
    а еще там смешная инфографика)![alt text](resources/image-3.png)

3. Чет кекнул в голос с этого.
    ![xtn](resources/image-7.png)
    ![alt text](https://i.imgur.com/GD537H6.jpeg)
4. <https://vz.ru> "_Взгляд как бы намекающий!_" :joy:
    ![alt text](https://i.imgur.com/AL3t4Cv.png)
    ![alt text](https://i.imgur.com/Y5yrEzB.png)
5. Больше всего конечно удивило отсутствие RSS на некоторых ресурсах. Хотя казалось бы, технология не сложная и сделана специально в угоду простоты распространения инфы.
    ...
    - <https://www.vesti.ru/> 
    - <https://www.1tv.ru/>  куки *уюки, где рсс ![alt text](resources/image.png)
    - <https://www.kommersant.ru/> зато можно подписаться! ![alt text](resources/image-4.png)
...
1. Оптимизация? Неее ![alt text](https://i.imgur.com/Ym0hTTZ.png)
2. Кому вебкит, а кому... ![alt text](https://i.imgur.com/Tn7cTqo.png)
3. Оставлять комменты в продакшене по определению очень скверная практика ![alt text](https://i.imgur.com/6GWk8Ug.png)
4. А то мало ли кто обнаружит твое русофобское говно ![alt text](https://i.imgur.com/H5rgkXz.png)
5. мммм, запросы в бд ![alt text](https://i.imgur.com/Y88gXBl.png)
6. Практически все сайты максимально плевали на приватность и крайне агрессивно рассылают инфу о каждом клике пользователя в лучшем случае 3 разным сборщикам метрик ![alt text](https://i.imgur.com/QXHTCdu.png)
...
И тут тоже нашлось с чего покекать, написал комменты по некоторым позициям.
